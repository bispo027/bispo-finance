...
export type ScheduledOperationAffectedDocument = Asset | Transaction;
...
export type TransactionManyWhereInput = {
  ...
  /** All values that are not equal to given value. */
  type_not?: InputMaybe<Scalars["Boolean"]>;
  updatedAt?: InputMaybe<Scalars["DateTime"]>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars["DateTime"]>;
  /** All values greater than or equal the given value. */
...
export function useTransactionsQuery(
  options?: Omit<Urql.UseQueryArgs<TransactionsQueryVariables>, "query">
) {
  return Urql.useQuery<TransactionsQuery, TransactionsQueryVariables>({
